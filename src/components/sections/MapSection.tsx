    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <PageTitle size="h2" className="mb-4 text-left!important">
              Visit Us
            </PageTitle>
            <p className="text-muted-foreground mb-6">
              We're conveniently located in the heart of Kanata. Stop by for your next appointment or feel free to give us a call.
            </p>
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Kanata, Ottawa, Ontario</p>
                </div>
              </div>
            </div>
            <Button asChild>
              <a href={businessInfo.mapUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2">
